...
impl EmotionalState {
    ...
    /// Record a positive interaction (successful quest, praise).
    ...
    /// Record a negative interaction (failed quest, correction).
...
mod tests {
    ...
    #[test]
    fn test_new_state() {
        let state = EmotionalState::new("aurelia");
    ...
    fn test_trust_progression() {
        let mut state = EmotionalState::new("aurelia");
    ...
    fn test_positive_ratio() {
        let mut state = EmotionalState::new("kael");
        state.record_positive();
        state.record_positive();
    ...
    fn test_save_and_load() {
        ...
        let mut state = EmotionalState::new("void");
        state.record_positive();
        state.record_positive();
        state.set_mood("content");
        state.save(&path).unwrap();

        let loaded = EmotionalState::load(&path, "void");
    ...
    #[test]
    fn test_as_context() {
        let state = EmotionalState::new("mira");
    ...
    fn test_path_for_agent() {
        let path = EmotionalState::path_for_agent(std::path::Path::new("/home/dev/agents/aurelia"));
        assert_eq!(path, std::path::PathBuf::from("/home/dev/agents/aurelia/.sigil/emotional_state.json"));
    }
}

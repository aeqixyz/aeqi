...
## A For-Profit Series Decentralized Autonomous Organization Limited Liability Company Organized Under the Laws of the Republic of the Marshall Islands
...
The Company is a for-profit Decentralized Autonomous Organization Limited Liability Company organized as a Series LLC. The Company is designated as a "[MEMBER-MANAGED / ALGORITHMICALLY MANAGED]" DAO LLC under the DAO Act. For-profit designation permits the Company to distribute profits and other economic benefits to Members holding Security Tokens.
...
The Company is organized for any lawful purpose permitted under the DAO Act and the LLC Act, including but not limited to [DESCRIBE PURPOSE: e.g., "the development, deployment, and operation of decentralized finance protocols, the management of digital asset treasuries, and the conduct of revenue-generating operations through on-chain and off-chain activities"]. The Company may engage in any and all activities necessary, convenient, desirable, or incidental to the foregoing.
...
The Company issues a security token (the "Security Token") representing economic ownership interests in the Company, deployed as an SPL Token-2022 token on the Solana blockchain at the following mint address:
...
(d) **Default Account State**: All token accounts are created in a frozen state and are unfrozen only upon satisfaction of applicable KYC requirements or confirmation that the holder's balance remains below applicable thresholds.
...
The Utility Token is not a security under Marshall Islands law. Pursuant to the 2023 Amendment to the DAO Act, "a governance token conferring no economic rights shall not be deemed a security." The Utility Token confers governance rights only, including the right to submit proposals, cast votes, and delegate voting power. The Utility Token does not confer any right to distributions, dividends, profit shares, liquidation preferences, or any other economic benefit.
...
Holders of Security Tokens ("Security Token Holders") are entitled to the following economic rights in proportion to their holdings relative to the total outstanding supply of Security Tokens:

(a) **Distributions**: The right to receive distributions of profits, revenues, or other economic benefits of the Company when and as declared by governance vote of the Utility Token Holders pursuant to Article VIII;

(b) **Liquidation Preference**: Upon dissolution and liquidation of the Company pursuant to Article XI, the right to receive a pro rata share of the Company's assets remaining after satisfaction of all liabilities and obligations;

(c) **Economic Interest**: A proportional economic ownership interest in the Company corresponding to the Security Token Holder's share of total outstanding Security Tokens.
...
(d) **No Economic Rights**: The Utility Token confers no right to distributions, dividends, profit shares, liquidation preferences, or any other economic benefit. Price appreciation of the Utility Token on secondary markets does not constitute an "economic right conferred by the token."
...
The Security Token represents an economic ownership interest in a for-profit DAO LLC. Under the DAO Act, tokens with economic rights issued by a for-profit DAO LLC are not automatically classified as securities and are not automatically exempt from securities classification. Each token issuance requires individual analysis under RMI securities law. However, the DAO Act exempts the Company from the Marshall Islands Securities and Investment Act "to the extent that a DAO LLC is not issuing, selling, exchanging or transferring any digital securities to residents of the Republic." The Company shall not issue, sell, exchange, or transfer Security Tokens to residents of the Republic of the Marshall Islands.
...
(g) Filing Gross Revenue Tax returns and remitting GRT payments on behalf of the Company;

(h) Receiving service of process on behalf of the Company;

(i) Maintaining encrypted KYC records off-chain in compliance with applicable data protection requirements;

(j) Operating the Transfer Hook compliance infrastructure, including sanctions screening and Restricted Person monitoring.
...
The Company has a single class of membership. All Members, whether holding Security Tokens, Utility Tokens, or both, are Members of the same class. Economic rights and governance rights are differentiated by token type, not by membership class.
...
| Treasury Distributions | [DISTRIBUTION THRESHOLD]% of votes cast | [DISTRIBUTION QUORUM]% of outstanding Utility Tokens |
...
Utility Token Holders may delegate their voting power to another Member by executing a delegation transaction through the Smart Contract. Delegation is revocable at any time. Delegated voting power does not transfer economic rights or Utility Token ownership.
...
The Company may distribute profits, revenues, or other economic benefits to Security Token Holders in proportion to their holdings of Security Tokens relative to the total outstanding supply of Security Tokens. Distributions require approval as a Treasury Distribution proposal through the Governance Program.

### Section 8.2 — Distribution Mechanics

Approved distributions shall be executed through the Smart Contract by transferring the distribution amount from the Company's treasury to the token accounts of Security Token Holders in proportion to their holdings at the time of the distribution snapshot. The distribution snapshot time shall be specified in the approved proposal.

### Section 8.3 — No Distribution via Utility Tokens

No distributions of profits, revenues, or other economic benefits shall be made to Members based on their holdings of Utility Tokens. Utility Tokens confer governance rights only.

### Section 8.4 — Tax Obligations

The Company is subject to the Gross Revenue Tax ("GRT") of three percent (3%) on earned income and interest. Capital gains and dividends received by the Company are excluded from GRT. The Foundation shall file GRT returns and remit GRT payments on behalf of the Company. No pass-through taxation to individual Members applies under Marshall Islands law. Individual Members remain subject to the tax laws of their respective countries of residence.

### Section 8.5 — No Withholding Tax

Distributions to Members are not subject to withholding tax under Marshall Islands law.

### Section 8.6 — Series Distributions

Distributions from a Series shall be made only from the assets of that Series and only to the Security Token Holders of that Series. The assets of one Series shall not be used to fund distributions of another Series.
...
The Company shall file an annual report with the Registrar of Corporations between January 1st and March 31st of each year. The annual report shall contain beneficial ownership information, leadership and management details, community engagement summary, financial information, confirmation of operational status, and any structural changes during the preceding year. The Foundation is responsible for preparing and filing the annual report.
...
### Section 10.6 — GRT Filing

The Foundation shall prepare and file the Company's GRT return on behalf of the Company and shall remit GRT payments due on earned income and interest. The Company shall maintain financial records sufficient to support the GRT return.

### Section 10.7 — Corporate Continuation
...
(c) Distributing the remaining assets of the Company and each Series to the Security Token Holders in proportion to their holdings of Security Tokens;

(d) Filing a notice of dissolution with the Registrar of Corporations.

### Section 11.3 — Series Dissolution

Dissolution of a Series does not cause dissolution of the Company or any other Series. Assets of a dissolved Series shall be distributed to the Security Token Holders of that Series in proportion to their holdings after satisfaction of all liabilities of that Series.

### Section 11.4 — No Distribution to Utility Token Holders

Upon dissolution, no assets shall be distributed to Members based on their holdings of Utility Tokens. All economic distributions upon dissolution shall be made to Security Token Holders.
...
| Distribution Quorum | [DISTRIBUTION QUORUM]% |
